...
class Program {
    ...
    static string Ejercicio2String()
    {
        string resultado;
    ...
    static void Main(string[] args)
    {
        ...
        while (continuar == true)
        {
            ...
            Console.WriteLine("3. Ejercicio 2.1: Numero PAR o IMPAR");
            Console.WriteLine("4. Ejercicio 2.2: Numero PAR o IMPAR con metodo que devuelve un String");
            ...
            switch (opcion)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    Console.WriteLine("El resultado es: " + Ejercicio2String());
                    Console.WriteLine("Presiones una tecla para volver al menu");
                    Console.ReadKey();
                    break;
                case "0":
